...
<body>
					...
					<div class="col-12 mt-3">
						<div class="card">
							<div class="card-body">
								...
								<form action="${base}/admin/manage_products" method="get">
									<div
										class="d-flex flex-row mb-3 search-form justify-content-between">
										<a href="${base }add_product">
													...
													<tr>
														...
														<td><span id="_product_status_${product.id}">
																<%-- <c:choose>
																	...
																	</c:choose> --%> <c:if test="${product.status ==true && product.quantity>0}">

																	<span class="true_status">Còn hàng</span>
																</c:if> <c:if test="${product.status !=true || product.quantity==0}">
																	<span class="false_status">Hết hàng</span>

																</c:if>
														</span></td>
														<td><a class="view_product_button"
															href="${base }/admin/manage_products/${product.id}"><i
																class="bi bi-eye "></i></a> <a
															href="${base }/admin/add_product/${product.id}"><i
	...
	function deleteProduct(productId) {
		...
		$(document).ready(function() {
			$('#category').val(${searchModel.categoryId });
